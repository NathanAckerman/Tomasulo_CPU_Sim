public class Unit {
    ...
    /*
     * \brief Performing one cycle of pipeline execution \param[in] instruction
     * Instruction to be added to the pipeline for execution
     *
     * If the last cell of the pipeline is not empty, the pipeline will stall It is
     * assumed that the CDB or the WB will pick up the instruction in the last cell
